...
class TransactionModelTest {
    ...
    void addTransaction_true() {
        ...
        int transactionId = transactionModel.addTransaction("Test", 100, "Test", LocalDate.now() );
    ...
    void deleteTransaction_true() {
        ...
        String username = "test";
        transactionModel.setCurrentUser(username, budgetId);
        int transactionId = transactionModel.addTransaction("Test", 100, "Test", null);
    ...
    void getTransactionList_true() {
        int budgetId = 1;
        transactionModel.setCurrentUser(username, budgetId);
        transactionModel.addTransaction("Test", 100, "Test", LocalDate.now());
