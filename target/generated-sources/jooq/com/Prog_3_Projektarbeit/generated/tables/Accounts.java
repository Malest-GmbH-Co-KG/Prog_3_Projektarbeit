...
import com.Prog_3_Projektarbeit.generated.tables.Users.UsersPath;
...
public class Accounts extends TableImpl<AccountsRecord> {
     ...
     */
    public final TableField<AccountsRecord, Float> BALANCE = createField(DSL.name("balance"), SQLDataType.REAL.defaultValue(DSL.field(DSL.raw("0"), SQLDataType.REAL)), this, "");
    ...
    public List<ForeignKey<AccountsRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ACCOUNTS__FK_ACCOUNTS_PK_USERS);
    }
    ...
    public UsersPath users() {
        if (_users == null)
            _users = new UsersPath(this, Keys.ACCOUNTS__FK_ACCOUNTS_PK_USERS, null);
